...
export default {
  ...
  COURSE: dedent`: As you are coaching teacher
    ...
    - Create 2 Courses With Course Name, Description, and 5/10 Chapters in each course
    ...
    - Also Make Easy, Moderate and Advance Course depends on topics and mention that in description
    ...
    - Generate 10/15 Quizz, 10 Flashcard and 10/15 Questions answer
